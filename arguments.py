...
def get_args_parser():
    ...
    # my parameter
    parser.add_argument('--enable_resnet50', action='store_true', help='enable resnet50')
    parser.add_argument('--enable_gru', action='store_true', help='enable gru')
    parser.add_argument('--enable_text_lambda', action='store_true', help='enable text lambda')
    parser.add_argument('--enable_visual_lambda1', action='store_true', help='enable visual lambda1')
    parser.add_argument('--enable_visual_lambda2', action='store_true', help='enable visual lambda1')
    parser.add_argument('--lamb', default=0.5, type=float,
                        help="my lambda")
    parser.add_argument('--enable_visual_prompt', action='store_true', help='enable visual prompt')
    parser.add_argument('--enable_unified_prompt', action='store_true', help='enable unified prompt')
    return parser