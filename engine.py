...
def evaluate(model, postprocessors, criterion, data_loader, device, args):
    ...
    visual_prompt = model.my_unified_to_visual(model.my_unified_prompt) if model.enable_unified_prompt else None
    ...
    for images, targets in metric_logger.log_every(data_loader, 10, header):
        ...
        vision_outputs = model.encode_image(images.tensors, visual_prompt, images.mask)
